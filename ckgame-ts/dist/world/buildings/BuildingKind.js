/** 建筑类型与数值。 */
export var BuildingKind;
(function (BuildingKind) {
    BuildingKind["FARM"] = "FARM";
    BuildingKind["BARRACKS"] = "BARRACKS";
    BuildingKind["WALLS"] = "WALLS";
    BuildingKind["MARKET"] = "MARKET";
    BuildingKind["CHURCH"] = "CHURCH";
    BuildingKind["WATCH_TOWER"] = "WATCH_TOWER";
...
export function buildingNameZh(kind) {
    return BUILDING_DATA[kind].nameZh;
}
export function buildingDescription(kind) {
    return BUILDING_DATA[kind].description;
}
export function buildingMaxLevel(kind) {
    return BUILDING_DATA[kind].maxLevel;
}
/** 升级到下一级所需的金币。 */
export function buildingUpgradeCost(kind, level) {
    return Math.floor(BUILDING_DATA[kind].baseCost * Math.pow(1.5, level));
}
/** 每级提供的效果值。 */
export function buildingEffectValue(kind, level) {
    return BUILDING_DATA[kind].effectPerLevel * level;
}
//# sourceMappingURL=BuildingKind.js.map