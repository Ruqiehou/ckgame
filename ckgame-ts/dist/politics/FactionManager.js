...
import { createFactionEvent } from './FactionEvent.js';
/**
...
export class FactionManager {
    ...
    recomputePower(militaryPower, liegePower) {
        for (const f of this.factions.values()) {
            let memberPower = 0;
...
//# sourceMappingURL=FactionManager.js.map